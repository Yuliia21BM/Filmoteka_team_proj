 ...
 */
(0,s("MjY8E").registerVersion)("firebase","9.15.0","app")})),s.register("MjY8E",(function(t,n){e(t.exports,"_registerComponent",(function(){return _})),e(t.exports,"_getProvider",(function(){return v})),e(t.exports,"SDK_VERSION",(function(){return I})),e(t.exports,"initializeApp",(function(){return T})),e(t.exports,"getApp",(function(){return E})),e(t.exports,"registerVersion",(function(){return k}));var i=s("6ExWU"),r=s("kZfxc"),o=s("2xDiJ"),a=(o=s("2xDiJ"),s("ajgRO"));
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I="9.15.0";function T(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const r=Object.assign({name:d,automaticDataCollectionEnabled:!1},t),s=r.name;if("string"!=typeof s||!s)throw b.create("bad-app-name",{appName:String(s)});if(n||(n=(0,o.getDefaultAppConfig)()),!n)throw b.create("no-options");const a=f.get(s);if(a){if((0,o.deepEqual)(n,a.options)&&(0,o.deepEqual)(r,a.config))return a;throw b.create("duplicate-app",{appName:s})}const c=new(0,i.ComponentContainer)(s);for(const e of m.values())c.addComponent(e);const l=new w(n,r,c);return f.set(s,l),l}function E(e=d){const t=f.get(e);if(!t&&e===d)return T();if(!t)throw b.create("no-app",{appName:e});return t}function k(e,t,n){var r;let s=null!==(r=p[e])&&void 0!==r?r:e;n&&(s+=`-${n}`);const o=s.match(/\s|\//),a=t.match(/\s|\//);if(o||a){const e=[`Unable to register library "${s}" with version "${t}":`];return o&&e.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&e.push("and"),a&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void h.warn(e.join(" "))}_(new(0,i.Component)(`${s}-version`,(()=>({library:s,version:t})),"VERSION"))}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var M;M="",_(new(0,i.Component)("platform-logger",(e=>new c(e)),"PRIVATE")),_(new(0,i.Component)("heartbeat",(e=>new R(e)),"PRIVATE")),k(l,u,M),k(l,u,"esm2017"),k("fire-js","")})),s.register("6ExWU",(function(t,n){e(t.exports,"Component",(function(){return r})),e(t.exports,"ComponentContainer",(function(){return c}));var i=s("2xDiJ");class r{setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}constructor(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ee{static credential(e,t){return ve._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=Te.parseLink(t);return v(n,"argument-error"),ve._fromEmailAndCode(e,n.code,n.tenantId)}constructor(){this.providerId=Ee.PROVIDER_ID}}Ee.PROVIDER_ID="password",Ee.EMAIL_PASSWORD_SIGN_IN_METHOD="password",Ee.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Et=new Map;class kt extends wt{async execute(){let e=Et.get(this.auth._key());if(!e){try{const t=await async function(e,t){const n=xt(t),i=St(e);if(!await i._isAvailable())return!1;const r="true"===await i._get(n);return await i._remove(n),r}(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(t)}catch(t){e=()=>Promise.reject(t)}Et.set(this.auth._key(),e)}return this.bypassAuthState||Et.set(this.auth._key(),(()=>Promise.resolve(null))),e()}async onAuthEvent(e){if("signInViaRedirect"===e.type)return super.onAuthEvent(e);if("unknown"!==e.type){if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}}function Ct(e,t){Et.set(e._key(),t)}function St(e){return I(e._redirectPersistence)}function xt(e){return J("pendingRedirect",e.config.apiKey,e.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var It,Tt;function Et(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let In,Tn;function En(e,t,n,i){const s=t.source.queryId;if(null!==s){const o=e.views.get(s);return(0,r.assert)(null!=o,"SyncTree gave us an op for an invalid query."),bn(o,t,n,i)}{let r=[];for(const s of e.views.values())r=r.concat(bn(s,t,n,i));return r}}function kn(e,t){let n=null;for(const i of e.views.values())n=n||yn(i,t);return n}class Cn{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Dt(null),this.pendingWriteTree_={visibleWrites:Ut.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Sn(e,t,n,i,s){return function(e,t,n,i,s){(0,r.assert)(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===s&&(s=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:s}),s&&(e.visibleWrites=Ft(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,s),s?Pn(e,new Ct({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function xn(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(Yt(e.pendingWriteTree_,t)){let t=new Dt(null);return null!=i.snap?t=t.set(fe(),!0):D(i.children,(e=>{t=t.set(new pe(e),!0)})),Pn(e,new kt(i.path,t,n))}return[]}function Nn(e,t,n){return Pn(e,new Ct({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function On(e,t,n,i){const r=Mn(e,i);if(null!=r){const i=Dn(r),s=i.path,o=i.queryId,a=Te(s,t);return Un(e,s,new Ct(Et(o),a,n))}return[]}function Rn(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=kn(n,Te(e,t));if(i)return i}));return Zt(i,t,r,n,!0)}function Pn(e,t){return An(t,e.syncPointTree_,null,Gt(e.pendingWriteTree_,fe()))}function An(e,t,n,i){if(Ie(e.path))return Ln(e,t,n,i);{const r=t.get(fe());null==n&&null!=r&&(n=kn(r,fe()));let s=[];const o=me(e.path),a=e.operationForChild(o),c=t.children.get(o);if(c&&a){const e=n?n.getImmediateChild(o):null,t=an(i,o);s=s.concat(An(a,c,e,t))}return r&&(s=s.concat(En(r,e,i,n))),s}}function Ln(e,t,n,i){const r=t.get(fe());null==n&&null!=r&&(n=kn(r,fe()));let s=[];return t.children.inorderTraversal(((t,r)=>{const o=n?n.getImmediateChild(t):null,a=an(i,t),c=e.operationForChild(t);c&&(s=s.concat(Ln(c,r,o,a)))})),r&&(s=s.concat(En(r,e,i,n))),s}function Mn(e,t){return e.tagToQueryMap.get(t)}function Dn(e){const t=e.indexOf("$");return(0,r.assert)(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new pe(e.substr(0,t))}}function Un(e,t,n){const i=e.syncPointTree_.get(t);(0,r.assert)(i,"Missing sync point for query tag that we're tracking");return En(i,n,Gt(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ci{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function li(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||Ee(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function ui(e,t,n){li(e,n),hi(e,(e=>ke(e,t)||ke(t,e)))}function hi(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(di(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function di(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();b&&T("event: "+n.toString()),q(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
