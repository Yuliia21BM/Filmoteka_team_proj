 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut=new E(3e4,6e4);function Ft(){const e=Ze().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let jt=null;function qt(e){return jt=jt||function(e){return new Promise(((t,n)=>{var i,r,s;function o(){Ft(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Ft(),n(m(e,"network-request-failed"))},timeout:Ut.get()})}if(null===(r=null===(i=Ze().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Ze().gapi)||void 0===s?void 0:s.load)){const t=dt("iframefcb");return Ze()[t]=()=>{gapi.load?o():n(m(e,"network-request-failed"))},ht(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw jt=null,e}))}(e),jt}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
